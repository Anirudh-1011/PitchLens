...
const GraniteCoach = memo(function GraniteCoach({
  ...
  const askGranite = useCallback(async (q: string) => {
    console.log("ASK GRANITE CALLED");
    ...
    <div style={{
      ...
      >
        ...
        <div style={{ flex:1, display:"flex", flexDirection:"column", minHeight:0 }}>
          <GraniteCoach moment={activeMoment} lens={lens} povPlayerLabel={cameraMode === "pov" ? povPlayerLabel : undefined} />
        </div>
